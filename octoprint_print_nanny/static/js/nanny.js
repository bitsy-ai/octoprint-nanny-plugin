...
$(function () {
    function PrintNannyTabViewModel(parameters) {
        ...
        self.imageData = ko.observable('plugin/print_nanny/static/img/sleeping.png');
        ...
        OctoPrint.socket.onMessage("*", function (message) {
            ...
            if (message && message.data && (
                message.data.type == 'plugin_print_nanny_monitoring_frame_b64'
            )
            ) {
            ...
            if (message && message.data && message.data.type == 'plugin_print_nanny_predict_offline') {
                console.log(message)
                self.imageData("plugin/print_nanny/static/img/sleeping.png");
            }
        });
        ...
        calibrate = function () {
            ...
            $('#tab_plugin_print_nanny_calibrate').empty()
            $('#tab_plugin_print_nanny_calibrate').append(calibrateImg);
        ...
        startMonitoring = function () {
            const url = OctoPrint.getBlueprintUrl('print_nanny') + 'startMonitoring'
        ...
        stopMonitoring = function () {
            const url = OctoPrint.getBlueprintUrl('print_nanny') + 'stopMonitoring'
            self.imageData("plugin/print_nanny/static/img/sleeping.png");
    ...
    OCTOPRINT_VIEWMODELS.push({
        ...
        dependencies: ["loginStateViewModel", "settingsViewModel"],
        // Elements to bind to, e.g. #settings_plugin_nanny, #tab_plugin_nanny, ...
        elements: ['#tab_plugin_print_nanny', '#navbar_plugin_print_nanny']
...
$(function () {
    function PrintNannySettingsViewModel(parameters) {
        ...
        OctoPrint.socket.onMessage("*", function (message) {
            if (message && message.data && (
                message.data.type == 'plugin_print_nanny_device_register_start' ||
                message.data.type == 'plugin_print_nanny_device_register_done' ||
                message.data.type == 'plugin_print_nanny_device_register_failed' ||
                message.data.type == 'plugin_print_nanny_device_printer_profile_sync_start' ||
                message.data.type == 'plugin_print_nanny_device_printer_profile_sync_done' ||
                message.data.type == 'plugin_print_nanny_device_printer_profile_sync_failed'
        ...
        registerDevice = function () {
            ...
            const url = OctoPrint.getBlueprintUrl('print_nanny') + 'registerDevice'
            OctoPrint.postJson(url, {
                'device_name': self.settingsViewModel.settings.plugins.print_nanny.device_name()
            })
                .done((res) => {
                    console.log(res)
        ...
        testAuthTokenInput = function () {
            ...
            OctoPrint.postJson(url, {
                ...
                .done((res) => {
                    ...
                    self.settingsViewModel.settings.plugins.print_nanny.auth_valid(true);
        ...
        saveAdvancedSettings = function () {
            ...
            OctoPrint.settings.savePluginSettings('print_nanny', {
                'ws_url': self.settingsViewModel.settings.plugins.print_nanny.ws_url(),
                'api_url': self.settingsViewModel.settings.plugins.print_nanny.api_url(),
                'monitoring_frames_per_minute': self.settingsViewModel.settings.plugins.print_nanny.monitoring_frames_per_minute(),
                'mqtt_bridge_hostname': self.settingsViewModel.settings.plugins.print_nanny.mqtt_bridge_hostname(),
                'mqtt_bridge_port': self.settingsViewModel.settings.plugins.print_nanny.mqtt_bridge_port(),
                'mqtt_bridge_certificate_url': self.settingsViewModel.settings.plugins.print_nanny.mqtt_bridge_certificate_url()
            })
                .done((res) => {
                    console.log(res)
                    testAuthTokenInput()
        ...
        testSnapshotUrl = function () {
            const url = OctoPrint.getBlueprintUrl('print_nanny') + 'testSnapshotUrl'
            OctoPrint.postJson(url, {
                'snapshot_url': self.settingsViewModel.settings.plugins.print_nanny.snapshot_url(),
            })
                .done((res) => {
                    console.log(res);
