...
from print_nanny.clients.rest import API_CLIENT_EXCEPTIONS
from print_nanny.exceptions import PluginSettingsRequired
from print_nanny.settings import PluginSettingsMemoize

from print_nanny.clients.honeycomb import HoneycombTracer
from print_nanny.types import PluginEvents, MonitoringModes

logger = logging.getLogger("octoprint.plugins.print_nanny.workers.mqtt")
...
class MQTTPublisherWorker:
    ...
    MUTED_EVENTS = [Events.Z_CHANGE, "plugin_print_nanny_monitoring_frame_b64"]
