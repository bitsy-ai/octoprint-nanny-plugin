...
import print_nanny.types
from print_nanny.workers.websocket import WebSocketWorker
from print_nanny.predictor import (
...
from print_nanny.clients.honeycomb import HoneycombTracer
from octoprint.events import Events
from print_nanny.types import PluginEvents, MonitoringModes
from print_nanny.utils.encoder import NumpyEncoder
import print_nanny.clients.flatbuffers

logger = logging.getLogger("octoprint.plugins.print_nanny.workers.monitoring")
...
class MonitoringWorker:
    ...
    def _create_active_learning_flatbuffer_msg(
        self, monitoring_frame: print_nanny.types.MonitoringFrame
    ) -> bytes:
        msg = print_nanny.clients.flatbuffers.build_telemetry_event_message(
            event_type=print_nanny.types.TelemetryEventEnum.monitoring_frame_raw,
    ...
    def _create_lite_fb_msg(
        ...
        return print_nanny.clients.flatbuffers.build_telemetry_event_message(
            event_type=print_nanny.types.TelemetryEventEnum.monitoring_frame_post,
            metadata=self._plugin.settings.metadata,
            monitoring_frame=monitoring_frame,
        )
    ...
    async def _active_learning_loop(self):
        ...
        (w, h) = pimage.size
        image = print_nanny.types.Image(height=h, width=w, data=image_bytes)
        monitoring_frame = print_nanny.types.MonitoringFrame(ts=ts, image=image)
    ...
    async def _lite_predict_and_calc_health(
        self, ts
    ) -> print_nanny.types.MonitoringFrame:
