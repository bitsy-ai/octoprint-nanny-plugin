...
from print_nanny.workers.monitoring import (
    MonitoringWorker,
)
...
from print_nanny.clients.mqtt import MQTTClient
...
logger = logging.getLogger("octoprint.plugins.print_nanny.settings")
...
class PluginSettingsMemoize:
    ...
    def metadata(self):
        ...
        return print_nanny.types.Metadata(
