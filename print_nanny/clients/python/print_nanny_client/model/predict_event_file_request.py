...
class PredictEventFileRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        """
        return {
            'annotated_image': (file_type,),  # noqa: E501
            'hash': (str,),  # noqa: E501
            'original_image': (file_type,),  # noqa: E501
        }
    ...
    @convert_js_args_to_python_args
    def __init__(self, annotated_image, hash, original_image, *args, **kwargs):  # noqa: E501
        """PredictEventFileRequest - a model defined in OpenAPI
