...
class PrintJob(object):
    ...
    def __init__(self, id=None, dt=None, name=None, gcode_file_hash=None, user=None, printer_profile=None, gcode_file=None, local_vars_configuration=None):  # noqa: E501
