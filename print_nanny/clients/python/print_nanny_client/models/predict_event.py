...
class PredictEvent(object):
    ...
    def __init__(self, dt=None, original_image=None, annotated_image=None, event_data=None, plugin_version=None, octoprint_version=None, user=None, print_job=None, local_vars_configuration=None):  # noqa: E501
