...
class EventsApi(object):
    ...
    def tracking_events_list(self, **kwargs):  # noqa: E501
        """tracking_events_list  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.tracking_events_list(async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.tracking_events_list_with_http_info(**kwargs)  # noqa: E501

    def tracking_events_list_with_http_info(self, **kwargs):  # noqa: E501
        """tracking_events_list  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.tracking_events_list_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method tracking_events_list" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
