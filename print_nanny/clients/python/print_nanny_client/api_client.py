...
from print_nanny_client.exceptions import ApiTypeError, ApiValueError, ApiException
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AuthTokenApi()
        api_instance.auth_token_create  # this is an instance of the class Endpoint
        api_instance.auth_token_create()  # this invokes api_instance.auth_token_create.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.auth_token_create.callable or self.callable in this class
