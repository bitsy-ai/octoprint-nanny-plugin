...
[**tracking_events_list**](EventsApi.md#tracking_events_list) | **GET** /api/tracking-events/ | 
...
with print_nanny_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.tracking_events_list()
    except ApiException as e:
        print("Exception when calling EventsApi->tracking_events_list: %s\n" % e)
```
