...
class OctoPrintEvent(object):
    ...
    def __init__(self, id=None, dt=None, event_type=None, event_data=None, plugin_version=None, octoprint_version=None, user=None):  # noqa: E501
        """OctoPrintEvent - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._dt = None
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OctoPrintEvent, dict):
