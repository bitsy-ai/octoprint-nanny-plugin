...
class PrintJob(object):
    ...
    def __init__(self, id=None, dt=None, name=None, gcode_file_hash=None, last_status=None, user=None, printer_profile=None, gcode_file=None):  # noqa: E501
        """PrintJob - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._dt = None
        self._name = None
